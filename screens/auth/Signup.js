      ...
      <MyStatusBar backgroundColor={'#030721'} />
        <KeyboardAvoidingView
          ...
          <ScrollView
            ...
            {pageIndex == 2 && (
              <>
                ...
                <Text style={{marginLeft:normalize(5),color:Colors.white,fontFamily:Fonts.Poppins_Regular,fontSize:normalize(11)}}>Username can only be letters, numbers, and _</Text>
              </>
            )}
            {pageIndex == 3 && (
              <>
            ...
            {pageIndex == 4 && (
              <>
                ...
                <TouchableOpacity  onPress={()=> setPageIndex(5)}  style={{width:normalize(100),alignSelf:'center',alignItems:'center',marginTop:normalize(18)}}><Text style={{color:'#6F79D1',fontFamily:Fonts.Poppins_Medium,fontSize:normalize(14)}}>Skip</Text></TouchableOpacity>
              </>
            )}
            {pageIndex == 5 && (
              <>
          ...
          <DateTimePicker
            ...
            onDateChange={val => {
              setdate(val), setdob(moment(val).format('YYYY-DD-MM')), setNewFormat(moment(val).format('MM-DD-YYYY')) ;
            }}
          ...
          />
          <View style={{display: toggle ? 'flex':'none', position:'absolute',left:0,top:0,height:'100%',width:'100%',zIndex:9999}}>
        <ScrollView contentContainerStyle={{paddingVertical:normalize(20)}} style={{ padding:20 ,backgroundColor:'#060C30'}}>
          <View style={{flexDirection:'row',justifyContent:'space-between'}}>
            <Text style={{fontSize:normalize(20),fontFamily:Fonts.Poppins_Bold,color:'white'}}>Terms & Conditions</Text>
            <TouchableOpacity onPress={()=> setToggle(false)} style={{height:normalize(24),width:normalize(24),borderRadius:30,backgroundColor:'white',justifyContent:'center',alignItems:'center'}}>
              <Image style={{height:normalize(20),width:normalize(20)}} source={Icons.cross}/>
            </TouchableOpacity>
          </View>
        <RenderHtml
              ...
              tagsStyles={{ p: { fontFamily: Fonts.Poppins_Regular, color: Colors.white } }}
            />
        </ScrollView>
        </View>
        </KeyboardAvoidingView>
