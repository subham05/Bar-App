...
export default function Yourpasses(props) {
  ...
  if (HomeReducer.status == 'Home/addCardSuccess') {
  ...
  return (
    <>
      ...
      <SafeAreaView style={{backgroundColor: Colors.darkblue, flex: 1}}>
        <Loader visible={HomeReducer.status == 'Home/addCardRequest'} />
        <View
          style={{
            height: normalize(60),
            // flexDirection: 'row',
          ...
          <View
            ...
            <Text
              ...
              Add<Text style={{color: Colors.pink}}> Card</Text>
            </Text>
          </View>
        </View>
        <ScrollView
